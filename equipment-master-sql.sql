...
(
    ...
    `AcquisitionValue`      float(11) DEFAULT NULL,
    ...
    `EquipmentIsAvailable`  varchar(1) DEFAULT NULL,
    `EquipmentIsInstalled`  varchar(1) DEFAULT NULL,
    `EquipIsAllocToSuperiorEquip` varchar(1) DEFAULT NULL,
